...
function showgriddata() {
	...
	var layerId = $('#layerId').combobox('getValue');
	var url = 'reportcar.do';
	var data = "id=801&date=" + date_start+"&end_date=" + date_end + "&layer=" + layerId + "&type=" + type + '&more=' + (isMore == null? 0 : parseInt(isMore, 10)) + "&timestamp=" + tempPara();
